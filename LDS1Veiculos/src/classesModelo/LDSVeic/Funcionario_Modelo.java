...
public class Funcionario_Modelo implements Serializable {
	...
	public Funcionario_Modelo(String nome, String apelido, String numBI, String numUnic, LocalDateTime data,
			String senha) {
