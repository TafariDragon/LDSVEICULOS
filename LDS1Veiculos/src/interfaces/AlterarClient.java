...
public class AlterarClient extends JFrame{
    ...
    public   AlterarClient()
    {
    	...
    	btnAlterar.setBounds(400, 50, 200, 30);
    ...
    private class TratamentoEventos implements ActionListener
    {
		...
		public void actionPerformed(ActionEvent e) 
	    {
			...
			if(e.getSource()==txtNome)
			{
				...
				{
					if(txtNome.getText().equalsIgnoreCase(receptor.get(i).getNumUnic()))
					{
						confirm=true;
						...
						txtNome.setText(receptor.get(i).getNumUnic());
						
						txtNumUnic.setText((receptor.get(i).getNome()));
			...
			{
				receptor.get(indice).setNome(txtNumUnic.getText());
				receptor.get(indice).setApelido(txtApelido.getText());
				receptor.get(indice).setNumBI(txtNumBI.getText());
				receptor.get(indice).setEmail(txtemail.getText());
				 
			
				memoryClient.vectClient=receptor;
