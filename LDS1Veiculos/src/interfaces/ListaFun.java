...
public class ListaFun extends JFrame {
	...
	JLabel lblinfo = new JLabel("LISTA DOS FUNCIONARIOS");
	...
	public void colocarDados ()
    {
    	...
    	total= receptor.size();
    	strTot=("Total Funcionarios "+total);
    	...
    	if(az==true)
    	{
    		 receptor.sort(Comparator.comparing(Funcionario_Modelo::getNome));
    	}
 ...
 ImageIcon back = new ImageIcon("icons/back.png");
	...
	public void configTabela()
	{
		...
		"Numero Unico","Data","Hora","Senha"}, 0);
	     ...
	     for(Funcionario_Modelo a :receptor)
	     {
	    	 int h = a.getData().getHour();
	    	 int min =a.getData().getMinute();
	    	 String hora =(h+"h : "+min+"min");
	    	 Object[] rowData = {a.getNome(),a.getApelido(),a.getNumBI(),a.getNumUnic(),a.getData(),
	    		 hora,a.getSenha()};
	...
	public  ListaFun()   
	{
		...
		int largura =835;
		 setTitle("Lista dos Funcionarios");
		 setSize(largura,500);
		 setVisible(true);
		 setResizable(false);
		 ...
		 painel1.setBackground(new Color(0,162,232));
		 painel1.setLayout(new FlowLayout());
		 painel1.add(lblinfo);
		 
		 painel2.setBounds(0, 40, largura, 40);
		 painel2.setLayout(null);
		 painel2.setBackground(new Color(0,162,232));
