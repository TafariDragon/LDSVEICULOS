...
public class ListaProcuraVeic extends JFrame {
	...
	JLabel lblinfo = new JLabel("LISTA PARA PROCURAR VEICULO");
 ...
 ImageIcon back = new ImageIcon("icons/back.png");
	...
	public  ListaProcuraVeic()   
	{
		...
		// tabela.setBounds(15, 80, 200, 250);
		 ...
		 //Evento na tabela classe interna anonima
				  ...
				  new MouseAdapter() {
					  ...
					  public void mouseClicked(MouseEvent e) 
					  {
			              ...
			              if (selectedRow != -1) {
			                    ...
			                    eft.efectuar.txtNumVeic.setText(value.toString());
			                    eft.efectuar.btnlimpar.setEnabled(true);
			                    eft.efectuar.txtNumVeic.setEditable(true);
			                    eft.efectuar.txtNumVeic.requestFocus();
			                    dispose();
