...
public class RemoverVenda_01 extends JFrame{
	
	
	ImageIcon simbolo = new ImageIcon("icons/iconLDS.png");
	JLabel info  = new JLabel("REMOVER DADOS DA VENDA");
    ...
    public  RemoverVenda_01()
    {
      ...
      ///////////////////////////////////////////////  
       ...
       for(int i =0; i<=2;i++)
       {
    	...
    	btnProcurar.setForeground(new Color(55,155,57));
    	

    	btnRemover.setBounds(500, 55, 200, 25);
    ...
    private class TratamentoEventos implements ActionListener
    {
		...
		public void actionPerformed(ActionEvent e) 
	    {
			...
			if(e.getSource()==btnRemover)
			{
				...
				memoryVendas.vectVendas=receptor;
				...
				JOptionPane.showMessageDialog(null, "DADOS DA VENDA REMOVIDOS COM SUCESSO");
				 dispose();
			}
